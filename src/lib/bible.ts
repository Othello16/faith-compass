// Book slug mapping for URL routing
...
export const ABBREV_TO_SLUG: Record<string, string> = Object.fromEntries(
  Object.entries(BOOK_SLUGS).map(([slug, abbrev]) => [abbrev, slug])
)
