      ...
      <div className="bg-[#0F172A] border border-white/15 rounded-2xl w-full max-w-sm p-6 shadow-2xl">
        ...
        {step === 'choice' && (
          <div className="space-y-3">
            ...
            {/* Social logins */}
            <button
              onClick={() => { localStorage.setItem('fc_pending_question', pendingQuestion.current || question); signIn('google', { callbackUrl: '/compass' }) }}
            ...
            <button
              onClick={() => { localStorage.setItem('fc_pending_question', pendingQuestion.current || question); signIn('apple', { callbackUrl: '/compass' }) }}
            ...
            <button
              onClick={() => { localStorage.setItem('fc_pending_question', pendingQuestion.current || question); signIn('twitter', { callbackUrl: '/compass' }) }}
              className="w-full flex items-center justify-center gap-3 bg-black border border-white/20 text-white py-2.5 rounded-xl text-sm font-medium hover:bg-white/5 transition"
            >
