          ...
          <div className="bg-[#C9A84C]/10 border border-[#C9A84C]/30 rounded-2xl p-5 mb-5">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-xs text-[#6B7280] hover:text-[#C9A84C] transition px-2 py-1 rounded-lg hover:bg-[#C9A84C]/10"
              >
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>
                Share
              </button>
            </div>
            <p className="text-[#1A1A1A] text-sm leading-relaxed whitespace-pre-wrap">{answer}</p>
          </div>
        )}
