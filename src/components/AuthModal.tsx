    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/70 backdrop-blur-sm px-4 pb-4 sm:pb-0">
      <div className="bg-white border border-gray-200 rounded-2xl w-full max-w-sm p-6 shadow-2xl">
        ...
        <div className="text-center mb-4">
          ...
          <p className="text-[#9CA3AF] text-xs mt-2 leading-relaxed">{previewLabel}</p>
          <p className="text-[#374151] text-xs italic mt-1 line-clamp-2 px-2">&ldquo;{pendingText}&rdquo;</p>
        </div>

        {/* STEP: Choice */}
        {step === 'choice' && (
          <div className="space-y-3">
            <h2 className="text-base font-bold text-center mb-4 text-[#0A0A0A]">Sign in to continue</h2>

            <button
              onClick={() => signIn('google', { callbackUrl })}
              className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 border border-gray-200 py-2.5 rounded-xl text-sm font-medium hover:bg-gray-50 transition"
            >
            ...
            <button
              ...
              className="btn-gold w-full py-2.5 rounded-xl text-sm font-semibold transition"
            >
              Sign in with Email
            </button>
            <button
          ...
          <>
            ...
            <form onSubmit={handleSignIn} className="space-y-3">
              ...
              <button type="submit" disabled={loading}
                className="btn-gold w-full py-2.5 rounded-xl text-sm font-semibold transition disabled:opacity-50">
